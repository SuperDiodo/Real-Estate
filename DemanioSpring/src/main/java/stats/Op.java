...
public class Op {
	...
	protected static Vector<Integer> conv(Vector<Concessione> vett, String field) {
		...
		for (Concessione thing : vett) {
			switch (field) {
			case "superficie":
				ids.add(thing.getSuperficie());
				break;
			case "supwater":
				ids.add(thing.getSupwater());
				break;
			case "durata":
				ids.add(thing.getDurata());
				break;
			default:
				return null;
			}
	...
	protected static Vector<String> convstr(Vector<Concessione> vett, String field) {
		...
		for (Concessione thing : vett) {
			switch (field) {
			case "nome":
				ids.add(thing.getNome());
				break;
			case "cognome":
				ids.add(thing.getCognome());
				break;
			case "RagSoc":
				ids.add(thing.getRagSoc());
				break;
			case "IDCom":
				ids.add(thing.getIDCom());
				break;
			case "comune":
				ids.add(thing.getComune());
				break;
			case "den":
				ids.add(thing.getDen());
				break;
			default:
				return null;
			}
