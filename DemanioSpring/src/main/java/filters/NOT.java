...
public class NOT extends Filter {
	 ...
	 * @param equal equal = true viene applicato il filtro not (si ricercano gli
	 *              elementi con valore diverso da quello di riferimento). equal =
	 *              false vengono cercati gli elementi con valore uguale a quello di
	 *              riferimento. La funzione tramite il flag approvato dice se
	 *              l'elemento processato rispetta i criteri di ricerca (approvato =
	 *              true) o meno (approvato = false).
	 * 
	 */
	@Override
