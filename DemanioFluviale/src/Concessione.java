...
public class Concessione{
	 ...
	 * @param iDCom Identificativo del comune in cui ricade l'atto di concessione
	...
	/**
	 * La funzione crea un oggetto che contiene i metadati che verranno mostrati dopo la richiesta al Controller.
